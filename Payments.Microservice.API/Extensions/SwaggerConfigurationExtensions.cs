...
using Payments.Microservice.API.Swagger.Filters;
...
namespace Payments.Microservice.API.Extensions
{
    ...
    public static class SwaggerConfigurationExtensions
    {
        ...
        public static void UseSwaggerWithUI(this IApplicationBuilder app)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "Games Micro serviço");
        ...
        public static void AddSwaggerServices(this IServiceCollection services)
        {
            services.AddSwaggerGen(options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo
                {
                    Title = "FGC API",
                    Version = "v1",
                    Description = "Documentação do Payments Micro serviço"
                });
